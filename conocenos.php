...
<body>
    ...
    <div class="page text-center text-md-left">
        ...
        <!--CONOCENOS-START-->
        <!-- Classic Breadcrumbs-->
        <section class="breadcrumb-classic bg-image" style="background-image: url(&quot;images/conocenos/header.jpg&quot;)">
            <div class="container">
            <div class="row">
                <ul class="list-breadcrumb">
                <li><a href="index.php">Inicio</a></li>
                <li><strong>Con&oacute;cenos</strong>
                </li>
                </ul>
            </div>
            </div>
        </section>
        <section class="section-50 section-sm-top-80 section-md-top-100 section-lg-top-150 bg-image bg-revail-lg bg-top-right">
            <div class="container">
            <div class="row">
                <div class="col-xl-6">
                <h1>Sobre nosotros</h1>
                <h2>Tradici&oacute;n por excelencia</h2>
                ...
                <div class="unit flex-row align-items-center unit-spacing-xl text-left justify-content-center justify-content-lg-start">
                    <div class="unit-left"><img class="img-responsive" src="images/conocenos/equipo/uno.jpg" alt="" width="109" height="102"/>
                    </div>
                    <div class="unit-body">
                    <h6>Emilio Cruz Lozano</h6><span class="small">Fundador, CEO</span>
                    </div>
                </div>
                </div>
            </div>
