        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-11 col-xxl-9">
              ...
              Las mejores páginas web ya no dependen sólo de la estética: 
              si pretendes competir necesitas un desarrollo web eficiente y posicionamiento web efectivo. 
              Unimos ambos conceptos para ayudarte a mejorar tu negocio.
              </p>
              <section class= "section-75 section-md-120 section-xl-80">

              <h2 class="offset-top-60 offset-sm-top-70 offset-md-top-80">
              Internet es una mina de oro de oportunidades para todo tipo de 
              negocios en todo el mundo. Utiliza su poder a tu favor
              </h2>
              <p class="inset-xxl-right-120">
              Un desarrollo web integral como el que proponemos desde eData no solamente aporta lo mejor del diseño
               web multidispositivo y el desarrollo con tecnología puntera, 
               también trae consigo toda la fuerza del posicionamiento web proactivo
              </p>
              <article>
                <h3 class="offset-top-60 offset-sm-top-70 offset-md-top-125">Ingeniería web</h3>
          ...
          <div class="row row-30 offset-top-50 offset-sm-top-50 offset-md-top-80">
            <div class="col-md-6 col-xl-4 col-xxl-3">
              ...
              <ul class="list list-marked list-marked-primary list-xs offset-top-20">
                <li>Creación de microsites</li>
                <li>Web responsive</li>
                <li>Posicionamientos SEO y SEM</li>
                <li>Pagos electrónicos</li>
              </ul>
            </div>
            <div class="col-md-6 col-xl-4 col-xxl-3">
            <h2>Multidispositivos</h2>
              <ul class="list list-marked list-marked-primary list-xs offset-top-20">
                <li>Soluciones robustas</li>
                <li>App de tiendas virtuales</li>
                <li>App fintech</li>
                <li>App nativas</li>
              </ul>
            </div>
