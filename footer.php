<footer class="page-footer page-footer-classic">
    <section class="section-75 section-sm-80 section-md-100 section-xl-150">
        ...
        <div class="row text-md-left row-55">
            ...
            <p class="offset-top-20 offset-md-top-35 inset-xxl-right-30">
                ...
                nuestra principal meta es alcanzar las suyas con total satisfacción.</p>
            </div>
            ...
            <ul class="list list-marked offset-top-30 list-xs offset-md-top-40">
                ...
                <li><a class="text-white" href="#">Carreras</a></li>
                <li><a class="text-white" href="#">Certificaciones</a></li>
            </ul>
            </div>
            ...
            <ul class="list list-marked offset-top-30 list-xs offset-md-top-40">
                <li><a class="text-white" href="#">Servicios</a></li>
                <li><a class="text-white" href="#">Contacto</a></li>
                <li><a class="text-white" href="#">Ub&iacute;quenos</a></li>
            </ul>
            </div>
            ...
            <div class="inset-xl-right-30"><span class="small text-spacing-340 text-white text-uppercase font-weight-bold page-footer-classic-title">Contact us</span>
                ...
                <li>
                    ...
                    <div class="unit-body"><a class="text-school-bus-yellow-white" href="#">Avenida la buena vida<br class="d-none d-md-block">M&eacute;rida, Yucat&aacute;n</a></div>
                    </div>
                </li>
                <li>
                    <div class="unit flex-row unit-spacing-xs">
                    <div class="unit-left"><span class="icon icon--school-bus-yellow fa-phone"></span></div>
                    <div class="unit-body"><a class="text-school-bus-yellow-white" href="tel:#">55-01-999-123</a></div>
                    </div>
                </li>
                <li>
                    <div class="unit flex-row unit-spacing-xs">
    ...
    <section class="section-25 bg-black-2">
        ...
        <div class="row align-items-md-center row-30">
            ...
            <p class="small-xs">Copyright	<span class="copyright-year"></span>	Todos los derechos reservados	.	
            </p>
            </div>
        </div>
        </div>
